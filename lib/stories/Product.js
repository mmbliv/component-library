...
export var Product = function (_a) {
    ...
    if (type === "block")
        return (_jsxs("div", __assign({ className: [
            ...
            ].join(" ") }, { children: [_jsxs("div", __assign({ className: "product-block--img-container" }, { children: [_jsx("img", { src: img, alt: "", className: "product-block--img" }), overlay && (_jsxs("div", __assign({ className: "product-overlay" }, { children: [_jsx("img", { src: iconActive ? "/activecart.png" : "/cart.png", alt: "cart" }), _jsx("img", { src: iconActive ? "/activeheart.png" : "/heart.png", alt: "heart" })] })))] })), _jsxs("div", __assign({ className: "product-block--content-container" }, { children: [column && _jsx("div", { className: "line" }), _jsx("p", __assign({ className: "product-block--name" }, { children: name })), _jsx("div", __assign({ className: "product-block--stars" }, { children: renderStar() })), _jsxs("p", __assign({ className: "product--price" }, { children: ["$", price, " ", _jsxs("span", __assign({ className: "product--old-price" }, { children: ["$", oldPrice] }))] }))] }))] })));
